...
export class ClipboardManager {
  ...
  uploadImageCache(rawData: DataTransfer | null, callback: (str: string) => void): boolean {
  ...
  uploadImageCacheWithUrl(rawData: DataTransfer | null, callback: (result: string) => void): void {
  ...
  public uploadImageCacheWithFile(file: File, callback: (result: string) => void): void {
